"""
Django settings for PretLoc project.
...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET",
    "django-insecure-_4)92r(ny9y3g2nbp2o0ch7$(j5+apt*8dddzz#x47wi^isqne",
)
...
WSGI_APPLICATION = "PretLoc.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DB_NAME", "gestion_materiel"),
...
# Configuration pour stocker les migrations dans un volume externe
MIGRATION_MODULES = {
    "admin": "data.migrations_data.admin",
    "auth": "data.migrations_data.auth",
